    ...
    <div class="yes-redir yes-normal yes-squeeze yes-sales<?php echo 'redir' === $page->getVar('type') ? ' hidden-field' : ''; ?>">
        <div class="form-group">
            ...
            <select name="public" class="form-control">
                <option value="1"<?php echo 1 == $page->getVar('public') ? ' selected="selected"' : ''; ?>><?php _e('Published', 'qpages'); ?></option>
                <option value="0"<?php echo 0 == $page->getVar('public') ? ' selected="selected"' : ''; ?>><?php _e('Draft', 'qpages'); ?></option>
            </select>
        </div>
